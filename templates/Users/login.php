                ...
                <div class="row">
                    <div class="col-lg-6 d-none d-lg-block bg-login-image">
                        <div id="login-unsplash-credit">
                            <?= __('Photo by') ?>
                            <a href="https://unsplash.com/@joelfilip?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" target="_blank">
                                Joel Filipe
                            </a>
                            <?= __('on') ?>
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" ng-submit="submit();">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" placeholder="<?= __('Username') ?>" ng-model="post.username">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-user" placeholder="<?= __('Password') ?>" ng-model="post.password">
                                </div>
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox small">
                                        <input type="checkbox" class="custom-control-input" id="customCheck" ng-true-value="1" ng-false-value="0" ng-model="post.remember_me">
